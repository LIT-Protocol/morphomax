...
/**
 * Filtering options for curators. AND operator is used for multiple filters, while OR operator is
 * used for multiple values in the same filter.
 */
...
/**
 * Filtering options for markets. AND operator is used for multiple filters, while OR operator is
 * used for multiple values in the same filter.
 */
...
export type MarketHistory = {
  ...
  /**
   * Amount borrowed on the market, in market share units. Amount does not increase as interest
   * accrue.
   */
  ...
  /**
   * Amount supplied on the market, in market share units. Amount does not increase as interest
   * accrue.
   */
...
export type MarketPosition = {
  ...
  market: Market;
  /**
   * Price variation required for the given position to reach its liquidation threshold (scaled by
   * WAD)
   */
...
/**
 * Filtering options for market positions. AND operator is used for multiple filters, while OR
...
export type MarketPositionHistory = {
  ...
  borrowAssetsUsd: Maybe<Array<FloatDataPoint>>;
  /**
   * Profit & Loss (from the loan asset's price variation and interest) of the borrow side of the
   * position since its inception, in loan assets.
   */
  borrowPnl: Maybe<Array<BigIntDataPoint>>;
  /**
   * Profit & Loss (from the loan asset's price variation and interest) of the borrow side of the
   * position since its inception, in USD for display purpose.
   */
  ...
  /**
   * Return Over Equity history of the borrow side of the position, taking into account the loan
   * asset's price variation.
   */
  ...
  /**
   * Profit & Loss (from the collateral asset's price variation) of the collateral of the position
   * since its inception, in USD for display purpose.
   */
  collateralPnlUsd: Maybe<Array<FloatDataPoint>>;
  /**
   * Return Over Equity history of the collateral of the position, taking into account the
   * collateral asset's price variation.
   */
  ...
  /**
   * Profit & Loss (from the assets' price variation and loan interest) of the margin of the
   * position since its inception, in loan assets.
   */
  marginPnl: Maybe<Array<BigIntDataPoint>>;
  /**
   * Profit & Loss (from the collateral asset's price variation and loan interest) of the margin of
   * the position since its inception, in USD for display purpose.
   */
  ...
  /**
   * Profit (from the collateral asset's price variation) & Loss (from the loan interest) history,
   * in loan assets.
   */
  pnl: Maybe<Array<BigIntDataPoint>>;
  /**
   * Profit (from the collateral asset's price variation) & Loss (from the loan interest) history,
   * in USD for display purposes.
   */
  ...
  supplyAssetsUsd: Maybe<Array<FloatDataPoint>>;
  /**
   * Profit & Loss (from the loan asset's price variation and interest) of the supply side of the
   * position since its inception, in loan assets.
   */
  ...
  /**
   * Return Over Equity history of the supply side of the position, taking into account the loan
   * asset's price variation.
   */
...
export type MarketPositionState = {
  ...
  /**
   * Return Over Equity of the borrow side of the position since its inception, taking into account
   * the loan asset's price variation.
   */
  ...
  /**
   * Return Over Equity of the collateral of the position since its inception, taking into account
   * the collateral asset's price variation.
   */
  ...
  /**
   * Return Over Equity of the margin of the position since its inception, taking into account
   * prices variation.
   */
  ...
  /**
   * Profit (from the collateral asset's price variation) & Loss (from the loan interest) of the
   * position since its inception, in loan assets.
   */
  ...
  /**
   * Return Over Equity of the supply side of the position since its inception, taking into account
   * the loan asset's price variation.
   */
...
export type MarketState = {
  ...
  /**
   * Total size of the market. This is the sum of all assets that are allocated or can be
   * reallocated to this market.
   */
  size: Scalars['BigInt']['output'];
  /**
   * Total size of the market. This is the sum of all assets that are allocated or can be
   * reallocated to this market, in USD for display purpose.
   */
  ...
  /**
   * Amount available to borrow on the market, including shared liquidity, in USD for display
   * purpose.
   */
...
/**
 * Filtering options for public allocator reallocates. AND operator is used for multiple filters,
...
export type Query = {
  ...
  /**
   * @deprecated Multiple Transaction entities correspond to a single hash, because a Transaction
   *   entity corresponds to an onchain event.
   */
...
export type TimeseriesOptions = {
  ...
  /**
   * The timestamp interval to space and group points. Defaults to around 50 points between
...
export type TransactionFilters = {
  ...
  assets_lte?: InputMaybe<Scalars['BigInt']['input']>;
  /**
   * Filter by greater than or equal to given amount of bad debt assets, in USD. Applies exclusively
   * to MarketLiquidation transactions.
   */
  badDebtAssetsUsd_gte?: InputMaybe<Scalars['Float']['input']>;
  /**
   * Filter by lower than or equal to given amount of bad debt assets, in USD. Applies exclusively
   * to MarketLiquidation transactions.
   */
  badDebtAssetsUsd_lte?: InputMaybe<Scalars['Float']['input']>;
  /**
   * Filter by greater than or equal to given amount of bad debt assets. Applies exclusively to
   * MarketLiquidation transactions.
   */
  badDebtAssets_gte?: InputMaybe<Scalars['BigInt']['input']>;
  /**
   * Filter by lower than or equal to given amount of bad debt assets. Applies exclusively to
   * MarketLiquidation transactions.
   */
  badDebtAssets_lte?: InputMaybe<Scalars['BigInt']['input']>;
  /**
   * Filter by greater than or equal to given amount of bad debt shares. Applies exclusively to
   * MarketLiquidation transactions.
   */
  badDebtShares_gte?: InputMaybe<Scalars['BigInt']['input']>;
  /**
   * Filter by lower than or equal to given amount of bad debt shares. Applies exclusively to
   * MarketLiquidation transactions.
   */
  ...
  marketUniqueKey_in?: InputMaybe<Array<Scalars['String']['input']>>;
  /**
   * Filter by greater than or equal to given amount of repaid shares, in USD. Applies exclusively
   * to MarketLiquidation transactions.
   */
  repaidAssetsUsd_gte?: InputMaybe<Scalars['Float']['input']>;
  /**
   * Filter by lower than or equal to given amount of repaid shares, in USD. Applies exclusively to
   * MarketLiquidation transactions.
   */
  repaidAssetsUsd_lte?: InputMaybe<Scalars['Float']['input']>;
  /**
   * Filter by greater than or equal to given amount of repaid shares. Applies exclusively to
   * MarketLiquidation transactions.
   */
  repaidAssets_gte?: InputMaybe<Scalars['BigInt']['input']>;
  /**
   * Filter by lower than or equal to given amount of repaid shares. Applies exclusively to
   * MarketLiquidation transactions.
   */
  ...
  search?: InputMaybe<Scalars['String']['input']>;
  /**
   * Filter by greater than or equal to given amount of seized shares, in USD. Applies exclusively
   * to MarketLiquidation transactions.
   */
  seizedAssetsUsd_gte?: InputMaybe<Scalars['Float']['input']>;
  /**
   * Filter by lower than or equal to given amount of seized shares, in USD. Applies exclusively to
   * MarketLiquidation transactions.
   */
  seizedAssetsUsd_lte?: InputMaybe<Scalars['Float']['input']>;
  /**
   * Filter by greater than or equal to given amount of seized shares. Applies exclusively to
   * MarketLiquidation transactions.
   */
  seizedAssets_gte?: InputMaybe<Scalars['BigInt']['input']>;
  /**
   * Filter by lower than or equal to given amount of seized shares. Applies exclusively to
   * MarketLiquidation transactions.
   */
...
export type UserState = {
  ...
  /**
   * Return Over Equity of the borrow side of all the user's market positions, taking into account
   * prices variation.
   */
  ...
  /**
   * Return Over Equity of the collateral of all the user's market positions, taking into account
   * prices variation.
   */
  ...
  /**
   * Return Over Equity of the margin of all the user's market positions, taking into account prices
   * variation.
   */
  ...
  /**
   * Profit (from the underlying asset's price variation) & Loss (from bad debt socialization) of
   * all the user's market positions, in USD.
   */
  ...
  /**
   * Return Over Equity of the supply side of all the user's market positions, taking into account
   * prices variation.
   */
  ...
  /**
   * Profit (from the underlying asset's price variation) & Loss (from bad debt socialization) of
   * all the user's vault positions, in USD.
   */
...
/**
 * Filtering options for users. AND operator is used for multiple filters, while OR operator is used
 * for multiple values in the same filter.
 */
...
/**
 * Filtering options for vault admin events. AND operator is used for multiple filters, while OR
 * operator is used for multiple values in the same filter.
 */
...
export type VaultAllocation = {
  ...
  market: Market;
  /**
   * Pending maximum amount of asset that can be supplied on market by the vault, in market
   * underlying token units
   */
  pendingSupplyCap: Maybe<Scalars['BigInt']['output']>;
  /**
   * Pending maximum amount of asset that can be supplied on market by the vault, in USD for display
   * purpose.
   */
  ...
  supplyAssetsUsd: Maybe<Scalars['Float']['output']>;
  /**
   * Maximum amount of asset that can be supplied on market by the vault, in market underlying token
   * units
   */
  supplyCap: Scalars['BigInt']['output'];
  /**
   * Maximum amount of asset that can be supplied on market by the vault, in USD for display
   * purpose.
   */
...
/**
 * Filtering options for vault positions. AND operator is used for multiple filters, while OR
 * operator is used for multiple values in the same filter.
 */
...
export type VaultPositionHistory = {
  ...
  /**
   * Profit (from the underlying asset's price variation) & Loss (from bad debt socialization) of
   * the position since its inception, in underlying assets.
   */
  pnl: Maybe<Array<BigIntDataPoint>>;
  /**
   * Profit (from the underlying asset's price variation) & Loss (from bad debt socialization) of
   * the position since its inception, in USD for display purposes.
   */
  pnlUsd: Maybe<Array<FloatDataPoint>>;
  /** Return Over Equity of the position since its inception. */
  roe: Maybe<Array<FloatDataPoint>>;
  /**
   * Return Over Equity of the position since its inception, taking into account the underlying
   * asset's price variation.
   */
  roeUsd: Maybe<Array<FloatDataPoint>>;
...
export type VaultPositionState = {
  ...
  id: Scalars['ID']['output'];
  /**
   * Profit (from the collateral's price variation) & Loss (from the loan interest) of the position
   * since its inception, in loan assets.
   */
  pnl: Maybe<Scalars['BigInt']['output']>;
  /**
   * Profit (from the collateral's price variation) & Loss (from the loan interest) of the position
   * since its inception, in USD.
   */
  pnlUsd: Maybe<Scalars['Float']['output']>;
  /** Return Over Equity of the position since its inception. */
  roe: Maybe<Scalars['Float']['output']>;
...
/**
 * Filtering options for vault reallocates. AND operator is used for multiple filters, while OR
 * operator is used for multiple values in the same filter.
 */
...
export type VaultState = {
  ...
  /**
   * 6h average vault APY excluding rewards, before deducting the performance fee (6h timeframe is
   * subject to change).
   */
  avgApy: Maybe<Scalars['Float']['output']>;
  /**
   * 6h average vault APY including rewards, after deducting the performance fee (6h timeframe is
   * subject to change).
   */
  ...
  id: Scalars['ID']['output'];
  /**
   * Stores the total assets managed by this vault when the fee was last accrued, in underlying
   * token units.
   */
...
export type VaultStateReward = {
  ...
  /**
   * Amount of reward tokens earned per supplied token (annualized). Scaled to reward asset
   * decimals.
   */
  amountPerSuppliedToken: Scalars['BigInt']['output'];
  asset: Asset;
  ...
  supplyApr: Maybe<Scalars['Float']['output']>;
  /**
   * Amount of reward tokens distributed to MetaMorpho vault suppliers (annualized). Scaled to
                                        ...
                                        { kind: 'Field', name: { kind: 'Name', value: 'name' } },
                                        {
                                          ...
                                          selectionSet: {
                                            ...
                                            selections: [
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'apy' },
                                              },
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'avgApy' },
                                              },
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'avgNetApy' },
                                              },
                                              {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'netApy' },
                                              },
                                            ],
                                          },
                                        },
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'name' } },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'netApyWithoutRewards' },
                            },
                          ],
                        },
                      },
                      { kind: 'Field', name: { kind: 'Name', value: 'symbol' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'whitelisted' } },
                    ],
                  },
                },
              ],
